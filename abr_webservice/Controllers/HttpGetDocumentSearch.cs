...
namespace abr_webservice.Controllers
{
    ...
    class HttpGetDocumentSearch : HttpGetSearch
    {
        ...
        {
            StringBuilder QueryString = new StringBuilder("http://abr.business.gov.au/abrxmlsearch/ABRXMLSearch.asmx/ABRSearchByABN?");
        ...
        {
            StringBuilder QueryString = new StringBuilder("http://abr.business.gov.au/abrxmlsearch/ABRXMLSearch.asmx/ABRSearchByASIC?");
            QueryString.Append("searchString=" + searchText);
            QueryString.Append("&includeHistoricalDetails=" + history);
            QueryString.Append("&authenticationGuid=" + guid);
            return QueryString.ToString();
        ...
        {
            StringBuilder QueryString = new StringBuilder("http://abr.business.gov.au/abrxmlsearch/ABRXMLSearch.asmx/ABRSearchByNameSimpleProtocol?");
        ...
        {
            StringBuilder QueryString = new StringBuilder("http://abr.business.gov.au/abrxmlsearch/ABRXMLSearch.asmx/SearchByPostcode?");
            QueryString.Append("postcode=" + postcode);
            QueryString.Append("&authenticationGuid=" + guid);
            return QueryString.ToString();
        }
