...
namespace abr_webservice.Controllers
{
    ...
    public abstract class HttpGetSearch
    {
        ...
        private static HttpWebRequest BuildRequest(string queryString)
        {
            ...
            try
            {
                Request.Timeout = int.Parse(WebConfigurationManager.AppSettings["RequestTimeoutInMilliseconds"], CultureInfo.CurrentCulture);
            }
            catch
            {
        ...
        {
            string ProxySetting = WebConfigurationManager.AppSettings["Proxy"];
